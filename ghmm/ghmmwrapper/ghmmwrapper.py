...
class ghmm_hyperparameters(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ghmm_hyperparameters, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ghmm_hyperparameters, name)
    __repr__ = _swig_repr
    __swig_setmethods__["type"] = _ghmmwrapper.ghmm_hyperparameters_type_set
    __swig_getmethods__["type"] = _ghmmwrapper.ghmm_hyperparameters_type_get
    if _newclass:type = _swig_property(_ghmmwrapper.ghmm_hyperparameters_type_get, _ghmmwrapper.ghmm_hyperparameters_type_set)
    __swig_setmethods__["num"] = _ghmmwrapper.ghmm_hyperparameters_num_set
    __swig_getmethods__["num"] = _ghmmwrapper.ghmm_hyperparameters_num_get
    if _newclass:num = _swig_property(_ghmmwrapper.ghmm_hyperparameters_num_get, _ghmmwrapper.ghmm_hyperparameters_num_set)
    __swig_getmethods__["emission"] = _ghmmwrapper.ghmm_hyperparameters_emission_get
    if _newclass:emission = _swig_property(_ghmmwrapper.ghmm_hyperparameters_emission_get)
    def alloc(self, *args): return _ghmmwrapper.ghmm_hyperparameters_alloc(self, *args)
    def __init__(self, *args): 
        this = _ghmmwrapper.new_ghmm_hyperparameters(*args)
        try: self.this.append(this)
        except: self.this = this
    def set_normal(self, *args): return _ghmmwrapper.ghmm_hyperparameters_set_normal(self, *args)
    def set_normal_truncated(self, *args): return _ghmmwrapper.ghmm_hyperparameters_set_normal_truncated(self, *args)
    def sample_emission_discrete(self, *args): return _ghmmwrapper.ghmm_hyperparameters_sample_emission_discrete(self, *args)
    def sample_emission(self, *args): return _ghmmwrapper.ghmm_hyperparameters_sample_emission(self, *args)
    def set_discrete(self, *args): return _ghmmwrapper.ghmm_hyperparameters_set_discrete(self, *args)
    __swig_destroy__ = _ghmmwrapper.delete_ghmm_hyperparameters
    __del__ = lambda self : None;
ghmm_hyperparameters_swigregister = _ghmmwrapper.ghmm_hyperparameters_swigregister
ghmm_hyperparameters_swigregister(ghmm_hyperparameters)

class ghmm_hyperparameters_emission(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ghmm_hyperparameters_emission, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ghmm_hyperparameters_emission, name)
    __repr__ = _swig_repr
    __swig_setmethods__["continuous"] = _ghmmwrapper.ghmm_hyperparameters_emission_continuous_set
    __swig_getmethods__["continuous"] = _ghmmwrapper.ghmm_hyperparameters_emission_continuous_get
    if _newclass:continuous = _swig_property(_ghmmwrapper.ghmm_hyperparameters_emission_continuous_get, _ghmmwrapper.ghmm_hyperparameters_emission_continuous_set)
    __swig_setmethods__["discrete"] = _ghmmwrapper.ghmm_hyperparameters_emission_discrete_set
    __swig_getmethods__["discrete"] = _ghmmwrapper.ghmm_hyperparameters_emission_discrete_get
    if _newclass:discrete = _swig_property(_ghmmwrapper.ghmm_hyperparameters_emission_discrete_get, _ghmmwrapper.ghmm_hyperparameters_emission_discrete_set)
    def __init__(self): 
        this = _ghmmwrapper.new_ghmm_hyperparameters_emission()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _ghmmwrapper.delete_ghmm_hyperparameters_emission
    __del__ = lambda self : None;
ghmm_hyperparameters_emission_swigregister = _ghmmwrapper.ghmm_hyperparameters_emission_swigregister
ghmm_hyperparameters_emission_swigregister(ghmm_hyperparameters_emission)

class ghmm_bayes_hmm(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ghmm_bayes_hmm, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ghmm_bayes_hmm, name)
    __repr__ = _swig_repr
    __swig_setmethods__["continuous"] = _ghmmwrapper.ghmm_bayes_hmm_continuous_set
    __swig_getmethods__["continuous"] = _ghmmwrapper.ghmm_bayes_hmm_continuous_get
    if _newclass:continuous = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_continuous_get, _ghmmwrapper.ghmm_bayes_hmm_continuous_set)
    __swig_setmethods__["dim"] = _ghmmwrapper.ghmm_bayes_hmm_dim_set
    __swig_getmethods__["dim"] = _ghmmwrapper.ghmm_bayes_hmm_dim_get
    if _newclass:dim = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_dim_get, _ghmmwrapper.ghmm_bayes_hmm_dim_set)
    __swig_setmethods__["N"] = _ghmmwrapper.ghmm_bayes_hmm_N_set
    __swig_getmethods__["N"] = _ghmmwrapper.ghmm_bayes_hmm_N_get
    if _newclass:N = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_N_get, _ghmmwrapper.ghmm_bayes_hmm_N_set)
    __swig_setmethods__["M"] = _ghmmwrapper.ghmm_bayes_hmm_M_set
    __swig_getmethods__["M"] = _ghmmwrapper.ghmm_bayes_hmm_M_get
    if _newclass:M = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_M_get, _ghmmwrapper.ghmm_bayes_hmm_M_set)
    __swig_setmethods__["params"] = _ghmmwrapper.ghmm_bayes_hmm_params_set
    __swig_getmethods__["params"] = _ghmmwrapper.ghmm_bayes_hmm_params_get
    if _newclass:params = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_params_get, _ghmmwrapper.ghmm_bayes_hmm_params_set)
    __swig_setmethods__["A"] = _ghmmwrapper.ghmm_bayes_hmm_A_set
    __swig_getmethods__["A"] = _ghmmwrapper.ghmm_bayes_hmm_A_get
    if _newclass:A = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_A_get, _ghmmwrapper.ghmm_bayes_hmm_A_set)
    __swig_setmethods__["pi"] = _ghmmwrapper.ghmm_bayes_hmm_pi_set
    __swig_getmethods__["pi"] = _ghmmwrapper.ghmm_bayes_hmm_pi_get
    if _newclass:pi = _swig_property(_ghmmwrapper.ghmm_bayes_hmm_pi_get, _ghmmwrapper.ghmm_bayes_hmm_pi_set)
    def __init__(self, *args): 
        this = _ghmmwrapper.new_ghmm_bayes_hmm(*args)
        try: self.this.append(this)
        except: self.this = this
    def set_hyperparameter(self, *args): return _ghmmwrapper.ghmm_bayes_hmm_set_hyperparameter(self, *args)
    def alloc(self, *args): return _ghmmwrapper.ghmm_bayes_hmm_alloc(self, *args)
    def sample_initial(self): return _ghmmwrapper.ghmm_bayes_hmm_sample_initial(self)
    def sample_transistions(self, *args): return _ghmmwrapper.ghmm_bayes_hmm_sample_transistions(self, *args)
    def sample_model_discrete(self): return _ghmmwrapper.ghmm_bayes_hmm_sample_model_discrete(self)
    def sample_model(self): return _ghmmwrapper.ghmm_bayes_hmm_sample_model(self)
    __swig_destroy__ = _ghmmwrapper.delete_ghmm_bayes_hmm
    __del__ = lambda self : None;
ghmm_bayes_hmm_swigregister = _ghmmwrapper.ghmm_bayes_hmm_swigregister
ghmm_bayes_hmm_swigregister(ghmm_bayes_hmm)
...
truncated_normal = _ghmmwrapper.truncated_normal
uniform = _ghmmwrapper.uniform
binormal = _ghmmwrapper.binormal
multinormal = _ghmmwrapper.multinormal
gamma_density = _ghmmwrapper.gamma_density
gamma_truncated = _ghmmwrapper.gamma_truncated
discrete = _ghmmwrapper.discrete
...
class ghmm_cmodel(_object):
    ...
    def fbgibbs(self, *args): return _ghmmwrapper.ghmm_cmodel_fbgibbs(self, *args)
    def cfbgibbs(self, *args): return _ghmmwrapper.ghmm_cmodel_cfbgibbs(self, *args)
